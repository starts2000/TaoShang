...
namespace Starts2000.TaoBao.Views
{
    public partial class Pagination : UserControl
    {
        ...
        public int PageIndex
        {
            ...
            set
            {
                if (_pageIndex != value)
                {
                    ...
                    {
                        stbPageIndex.SkinTxt.Text = _pageIndex.ToString();
                    }
        ...
        void Init()
        {
            lbFirst.Image = ViewResource.ViewResources.first;
            lbPrev.Image = ViewResource.ViewResources.prev;
            lbNext.Image = ViewResource.ViewResources.next;
            lbLast.Image = ViewResource.ViewResources.last;
            lbReload.Image = ViewResource.ViewResources.reload;

            lbPageSize.Text = "15";
            stbPageIndex.SkinTxt.Text = "1";
            lbPageNum.Text = "1";
            CheckEnable();

            stbPageIndex.SkinTxt.KeyUp += (sender, e) =>
            {
                if (e.KeyCode == Keys.Enter && e.Modifiers == Keys.None)
                {
                    int pageIndex;
                    if (int.TryParse(stbPageIndex.SkinTxt.Text.Trim(), out pageIndex))
                    {
